...
<head>
    ...
    <!-- Fav Icon  -->
    <link rel="shortcut icon" href="<?php echo base_url();?>home-assets/images/favicon.png">
    <!-- Site Title  -->
    <title>Kovid19 | Coronavirus (COVID-19) Prevention & Informatics HTML Template</title>
    <!-- Bundle and Base CSS -->
    <link rel="stylesheet" href="<?php echo base_url();?>home-assets/css/bundle.css?ver=112">
    <link rel="stylesheet" href="<?php echo base_url();?>home-assets/css/styles.css?ver=112">
</head>
                    ...
                    <div class="nk-navbar-wrap">
                        <div class="nk-navbar-logo logo">
                            <a href="./" class="logo-link">
                                <img class="logo-dark" src="<?php echo base_url();?>home-assets/images/logo-dark.png" srcset="<?php echo base_url();?>home-assets/images/logo-dark2x.png 2x" alt="logo">
                                <img class="logo-light" src="<?php echo base_url();?>home-assets/images/logo-white.png" srcset="<?php echo base_url();?>home-assets/images/logo-white2x.png 2x" alt="logo">
                            </a>
                        </div><!-- .nk-navbar-logo -->
                    ...
                    <div class="row g-gs align-items-center justify-content-between">
                        <div class="col-lg-5 order-lg-last">
                            <div class="nk-banner-image">
                                <img src="<?php echo base_url();?>home-assets/images/gfx/header-a.png" alt="">
                            </div>
                        </div><!-- .col -->
                        <div class="col-lg-6">
                            <div class="nk-banner-block">
                                <div class="content">
                                    ...
                                    <ul class="nk-banner-btns">
                                        <li><a href="<?php echo base_url();?>Home/register" class="btn scrollto"><span>DAFTAR</span></em></a></li>
                                        <li><a href="<?php echo base_url();?>Home/login" class="btn scrollto"><span>MASUK</span></em></a></li>
                                    </ul>
                    ...
                    <div class="section-content">
                        <div class="row g-gs justify-content-center">
                            <div class="col-sm-10 col-md-8 col-lg-4">
                                <div class="box">
                                    <div class="box-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/spread-a.png" alt="">
                                    </div>
                            ...
                            <div class="col-sm-10 col-md-8 col-lg-4">
                                <div class="box">
                                    <div class="box-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/spread-b.png" alt="">
                                    </div>
                                    <div class="box-content">
                            ...
                            <div class="col-sm-10 col-md-8 col-lg-4">
                                <div class="box">
                                    <div class="box-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/spread-c.png" alt="">
                                    </div>
                                    <div class="box-content">
                    ...
                    <div class="section-content">
                        <div class="row g-gs justify-content-center">
                            <div class="col-sm-10 col-md-8 col-lg-4">
                                <div class="box2">
                                    <div class="box2-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/symptom-a.png" alt="">
                                    </div>
                            ...
                            <div class="col-sm-10 col-md-8 col-lg-4">
                                <div class="box2">
                                    <div class="box2-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/symptom-b.png" alt="">
                                    </div>
                                    <div class="box2-content">
                            ...
                            <div class="col-sm-10 col-md-8 col-lg-4">
                                <div class="box2">
                                    <div class="box2-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/symptom-c.png" alt="">
                                    </div>
                                    <div class="box2-content">
                    ...
                    <div class="section-content">
                        <div class="row g-gs gy-sm-m">
                            <div class="col-lg-3 col-sm-6">
                                <div class="box3">
                                    <div class="box3-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/advice-a.png" alt="">
                                    </div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="box3">
                                    <div class="box3-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/advice-b.png" alt="">
                                    </div>
                                    <div class="box3-content">
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="box3">
                                    <div class="box3-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/advice-c.png" alt="">
                                    </div>
                                    <div class="box3-content">
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="box3">
                                    <div class="box3-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/advice-d.png" alt="">
                                    </div>
                                    <div class="box3-content">
                ...
                <div class="container">
                    <div class="section-content section-content-boxed">
                        <div class="row g-gs justify-content-center align-items-center">
                            ...
                            <div class=" col-sm-10 col-md-8 col-lg-4">
                                <img src="<?php echo base_url();?>home-assets/images/gfx/steps.png" class="mb-2 mb-sm-0" alt="">
                            </div><!-- .col -->
                        </div><!-- .row -->
                    </div><!-- .section-content -->
                </div><!-- .container -->
                    ...
                    <div class="section-content">
                        <div class="row g-gs justify-content-center">
                            <div class="col-6 col-mb-5 col-sm-4 col-lg-2">
                                <div class="box4">
                                    <div class="box4-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/hand-a.png" alt="">
                                    </div>
                            ...
                            <div class="col-6 col-mb-5 col-sm-4 col-lg-2">
                                <div class="box4">
                                    <div class="box4-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/hand-b.png" alt="">
                                    </div>
                                    <div class="box4-content">
                            ...
                            <div class="col-6 col-mb-5 col-sm-4 col-lg-2">
                                <div class="box4">
                                    <div class="box4-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/hand-c.png" alt="">
                                    </div>
                                    <div class="box4-content">
                            ...
                            <div class="col-6 col-mb-5 col-sm-4 col-lg-2">
                                <div class="box4">
                                    <div class="box4-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/hand-d.png" alt="">
                                    </div>
                                    <div class="box4-content">
                            ...
                            <div class="col-6 col-mb-5 col-sm-4 col-lg-2">
                                <div class="box4">
                                    <div class="box4-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/hand-e.png" alt="">
                                    </div>
                                    <div class="box4-content">
                            ...
                            <div class="col-6 col-mb-5 col-sm-4 col-lg-2">
                                <div class="box4">
                                    <div class="box4-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/hand-f.png" alt="">
                                    </div>
                                    <div class="box4-content">
                        ...
                        <div class="row g-gs justify-content-center flex-lg-nowrap">
                            <div class="col-md-8 col-lg-5 col-xl-6 align-self-end">
                                <div class="protect-block-gfx">
                                    <img src="<?php echo base_url();?>home-assets/images/gfx/protect.png" alt="">
                                </div>
                            </div><!-- .col -->
                            <div class="col-6 col-mb-5 col-sm-6 col-lg-4 col-xl-3 flex-grow-1 order-lg-first">
                                <div class="protect-item negative">
                                    <div class="protect-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/donts-a.png" alt="">
                                    </div>
                                ...
                                <div class="protect-item negative">
                                    <div class="protect-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/donts-b.png" alt="">
                                    </div>
                                    <div class="protect-text">
                                ...
                                <div class="protect-item negative">
                                    <div class="protect-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/donts-c.png" alt="">
                                    </div>
                                    <div class="protect-text">
                            ...
                            <div class="col-6 col-mb-5 col-sm-6 col-lg-4 col-xl-3 flex-grow-1 ">
                                <div class="protect-item positive">
                                    <div class="protect-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/dos-a.png" alt="">
                                    </div>
                                    <div class="protect-text">
                                ...
                                <div class="protect-item positive">
                                    <div class="protect-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/dos-b.png" alt="">
                                    </div>
                                    <div class="protect-text">
                                ...
                                <div class="protect-item positive">
                                    <div class="protect-gfx">
                                        <img src="<?php echo base_url();?>home-assets/images/gfx/dos-c.png" alt="">
                                    </div>
                                    <div class="protect-text">
                    ...
                    <div class="section-content">
                        <div class="row g-gs justify-content-center">
                            <div class="col-md-9 col-lg-4">
                                <div class="blog-item">
                                    <div class="blog-image">
                                        <img src="<?php echo base_url();?>home-assets/images/blog/blog-a.jpg" alt="">
                                    </div>
                                    <div class="blog-text">
                            ...
                            <div class="col-md-9 col-lg-4">
                                <div class="blog-item">
                                    <div class="blog-image">
                                        <img src="<?php echo base_url();?>home-assets/images/blog/blog-b.jpg" alt="">
                                    </div>
                                    <div class="blog-text">
                            ...
                            <div class="col-md-9 col-lg-4">
                                <div class="blog-item">
                                    <div class="blog-image">
                                        <img src="<?php echo base_url();?>home-assets/images/blog/blog-c.jpg" alt="">
                                    </div>
                                    <div class="blog-text">
                ...
                <div class="container">
                            ...
                            <div class="col-lg-3 col-md-9 mr-auto">
                                <div class="wgs wgs-about">
                                    <div class="wgs-logo logo">
                                        <a href="./" class="logo-link">
                                            <img src="<?php echo base_url();?>home-assets/images/logo-white.png" srcset="<?php echo base_url();?>home-assets/images/logo-white2x.png 2x" alt="logo">
                                        </a>
                                    </div>
                    ...
                    <div class="nk-footer-bottom">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <p class="nk-copyright">&copy; 2020 KOVID-19. Template Made by <a href="https://softnio.com">Agus Wijiyanto</a>.</p>
                            </div><!-- .col -->
                            <div class="col-md-6">
